...
!((e, t) => {
        ...
        unparse: (e, t) => {
          ...
          !(() => {
            ...
            "string" != typeof t.delimiter ||
              b.BAD_DELIMITERS.filter((e) => -1 !== t.delimiter.indexOf(e)).length ||
              (m = t.delimiter)
          ...
          function u(e, t, i) {
            ...
            for (var o = 0; o < t.length; o++) {
              ...
              if (
                (i &&
                  !n &&
                  (u = "greedy" === i ? "" === t[o].join("").trim() : 1 === t[o].length && 0 === t[o][0].length),
                "greedy" === i && n)
              ) {
                for (var d = [], l = 0; l < h; l++) {
                  var c = s ? e[l] : l
    ...
    function u(e) {
      ;(this._handle = null),
        ...
        function (e) {
          var t = w(e)
          ;(t.chunkSize = Number.parseInt(t.chunkSize)), e.step || e.chunk || (t.chunkSize = null)
        ...
        (this.parseChunk = function (e, t) {
          ...
          if (!this._handle.paused() && !this._handle.aborted()) {
            var s = n.meta.cursor
            this._finished || ((this._partialLine = r.substring(s - this._baseIndex)), (this._baseIndex = s)),
                ...
                (this._finished =
                  ...
                  this._start >=
                    ((e) => {
                      ...
                      if (null === t) return -1
                      return Number.parseInt(t.substring(t.lastIndexOf("/") + 1))
                    })(r)),
    ...
    function c(e) {
      ...
      ;(this.stream = function (e) {
        ;(this._input = e),
          ...
          s
            ? (((r = new FileReader()).onload = v(this._chunkLoaded, this)), (r.onerror = v(this._chunkError, this)))
    ...
    function g(e) {
      ...
      ;(this.pause = function () {
        ...
        (this._checkIsFinished = function () {
          i && t.length <= 0 && (this._finished = !0)
        }),
        (this._nextChunk = function () {
          this._checkIsFinished(), t.length ? this.parseChunk(t.shift()) : (r = !0)
        }),
        (this._streamData = function (e) {
          try {
            t.push("string" == typeof e ? e : e.toString(this._config.encoding)), r && ((r = !1), this._nextChunk())
          } catch (e) {
            this._streamError(e)
          }
        }),
        (this._streamError = function (e) {
    ...
    function i(m) {
      ...
      if (M(m.step)) {
        ...
        m.step = (e) => {
          if (((c = e), _())) g()
            ...
            ;(i += e.data.length), m.preview && i > m.preview ? o.abort() : ((c.data = c.data[0]), p(c, this))
          }
        }
      }
      function y(e) {
      ...
      function g() {
        return (
          h &&
            ...
            (a = !1)),
          m.skipEmptyLines && (c.data = c.data.filter((e) => !y(e))),
          _() &&
            (() => {
              if (!c) return
              function e(e, t) {
          ...
          (() => {
            ...
            var t = 1
            !c.data.length || Array.isArray(c.data[0]) ? ((c.data = c.data.map(e)), (t = 0)) : (c.data = e(c.data, 0))
      ...
      function v(e, t) {
        return (
          (i = e),
          m.dynamicTypingFunction && void 0 === m.dynamicTyping[i] && (m.dynamicTyping[i] = m.dynamicTypingFunction(i)),
      ...
      ;(this.parse = (e, t, i) => {
          ...
          var n = ((e, t, i, r, n) => {
            ...
            for (var u = 0; u < n.length; u++) {
              ...
              0 < p.data.length && (l /= p.data.length - c),
                (void 0 === a || d <= a) && (void 0 === h || h < l) && 1.99 < l && ((a = d), (s = f), (h = l))
            }
        ...
        (this.resume = () => {
          this.streamer._halted ? ((d = !1), this.streamer.parseChunk(a, !0)) : setTimeout(this.resume, 3)
        }),
        (this.aborted = () => e),
        (this.abort = () => {
      ...
      if (t.error) i.userError(t.error, t.file)
        ...
        if (M(i.userStep)) {
          for (
            ...
            (i.userStep({ data: t.results.data[s], errors: t.results.errors, meta: t.results.meta }, n), !r);
            s++
          );
          delete t.results
